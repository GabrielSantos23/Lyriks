...
const App = () => {
  ...
  return (
    <div className='relative flex'>
      <Sidebar />
      <div className='flex flex-1 flex-col bg-[#1F2029]'>
        <Searchbar />
      ...
      {activeSong?.title && (
        <div className='absolute bottom-0 left-0 right-0 z-10 flex h-28 animate-slideup rounded-t-3xl bg-opacity-90 bg-gradient-to-br from-black to-[#17181C] backdrop-blur-lg'>
          <MusicPlayer />
        </div>
      )}
    </div>
